...
plt.plot(np.arange(1,newLen+1), non_Norm_Out , label='Real Sequence', color='blue')

plt.legend(['full energy','data_predicted'],
           loc=3)
plt.xlabel('Length')
...
plt.show()
thisfig.savefig("Pred06.pdf", bbox_inches='tight')
plt.close()
print('\n')
